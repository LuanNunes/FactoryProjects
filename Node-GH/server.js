...
passport.use(
  new GithubStrategy({
    ...
    callbackUrl: 'https://localhost:3000/login/github/return',
    scope: scopes.join(' ')
  },
...
app.get('/logoff', function (res, res) {
  res.clearCookie(COOKIE);
  res.redirect('/');
})

app.get('/auth/github', passport.authenticate('github'));
app.get('/login/github/return', passport.authenticate('github', { successRedirect: '/setcookie', failureRedirect: '/' }));
